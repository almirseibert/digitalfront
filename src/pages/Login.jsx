      ...
      <div className="max-w-4xl w-full bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row">
        <div className="w-full md:w-1/2 bg-slate-900 p-12 text-white flex flex-col justify-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-slate-400 text-lg">Faça login para aceder ao seu CRM, gerir leads e acompanhar os resultados em tempo real.</p>
          </div>
        </div>
        <div className="w-full md:w-1/2 p-12 flex flex-col justify-center">
          <div className="mb-10">
            <h2 className="text-2xl font-bold text-slate-800">Bem-vindo de volta! 👋</h2>
            <p className="text-slate-500 mt-2">Introduza as suas credenciais para continuar.</p>
          </div>
          <form onSubmit={handleLogin} className="space-y-6">
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="exemplo@digitalplus.com" className="w-full pl-10 pr-4 py-3 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-slate-50 transition-all" required />
              </div>
            </div>
            <div>
            ...
            <button type="submit" disabled={isLoading} className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-lg flex items-center justify-center gap-2 transition-colors shadow-lg shadow-blue-600/30 disabled:opacity-70">
          ...
          <p className="text-center text-sm text-slate-500 mt-8">Sistema restrito a funcionários da digit@l plus+.</p>
        </div>
      </div>
    </div>
  );
